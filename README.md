...
```javascript
import someOwnBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-some-own-by@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/utils-some-own-by/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/utils-some-own-by/actions/workflows/test.yml?query=branch:v0.1.0
